...
bool DatabaseManager::seed_problem1_data() {
    ...
    {"Мемокод-2024", 12, "кодировка для мемов (1.5 байта на символ)"},
    {"TikTok-Encoding", 9, "кодировка для коротких видео (1.125 байта на символ)"},
    {"Гигачад-Код", 64, "ультрасовременная кодировка (8 байт на символ)"},
    {"Киберпанк-2077", 13, "футуристическая кодировка (1.625 байта на символ)"},
    {"Аниме-Кодировка", 10, "кодировка для аниме (1.25 байта на символ)"},
    {"Котокод", 7, "кодировка для котов (0.875 байта на символ)"},
    {"ИИ-Генератор", 11, "нейросетевая кодировка (1.375 байта на символ)"},
