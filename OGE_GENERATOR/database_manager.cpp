...
bool DatabaseManager::seed_problem1_data() {
    ...
    vector<tuple<string, int, string>> encodings = {
        {"КОИ-8", 8, "кодировка для русского алфавита"},
        {"UTF-8", 8, "универсальная кодировка"},
        {"Windows-1251", 8, "кодировка Windows для кириллицы"},
        {"ASCII", 7, "американская стандартная кодировка"},
        {"UTF-16", 16, "16-битная кодировка Unicode"},
        {"UTF-32", 32, "32-битная кодировка Unicode"}
    };
    ...
    vector<tuple<string, string>> words = {
        // Реки
        {"Обь", "реки"}, {"Лена", "реки"}, {"Волга", "реки"},
        {"Енисей", "реки"}, {"Амазонка", "реки"}, {"Нил", "реки"},
        {"Днепр", "реки"}, {"Дон", "реки"}, {"Нева", "реки"}, {"Кама", "реки"},

        // Города
        {"Москва", "города"}, {"Лондон", "города"}, {"Париж", "города"},
        {"Берлин", "города"}, {"Токио", "города"}, {"Пекин", "города"},
        {"Рим", "города"}, {"Мадрид", "города"}, {"Киев", "города"}, {"Минск", "города"},

        // Горы
        {"Эльбрус", "горы"}, {"Эверест", "горы"}, {"Килиманджаро", "горы"},
        {"Монблан", "горы"}, {"Аконкагуа", "горы"}, {"Мак-Кинли", "горы"},
        {"Казбек", "горы"}, {"Арарат", "горы"}, {"Урал", "горы"}, {"Альпы", "горы"},

        // Страны
        {"Россия", "страны"}, {"Франция", "страны"}, {"Германия", "страны"},
        {"Китай", "страны"}, {"США", "страны"}, {"Япония", "страны"},
        {"Италия", "страны"}, {"Испания", "страны"}, {"Украина", "страны"}, {"Беларусь", "страны"}
    };
